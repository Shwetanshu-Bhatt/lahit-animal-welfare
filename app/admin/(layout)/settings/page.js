        ...
        <div className="card-body">
          ...
          {activeTab === 'social' && (
            <div>
              ...
              <h2 className="text-xl font-bold text-primary mb-4">Instagram Posts (Homepage Feed)</h2>
              <div className="space-y-4 mb-4">
                {(settings.instagramPosts || []).map((post, index) => (
                  <div key={post.id || index} className="flex gap-4 items-start p-4 bg-base-200 rounded-xl">
                    <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4">
                      <input
                        type="text"
                        value={post.image}
