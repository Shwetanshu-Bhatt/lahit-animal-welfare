            ...
            return (
              ...
              >
                <Card className="text-center h-full" padding="xl">
                  <div className="w-16 h-16 bg-[#164020]/10 rounded-2xl flex items-center justify-center mx-auto mb-6">
                    <Icon className="w-8 h-8 text-[#164020]" />
                  </div>
                  <h3 className="text-4xl sm:text-5xl font-bold text-[#401E01] mb-2">
                    <AnimatedCounter value={stat.value} suffix={stat.suffix} />
                  </h3>
                  <p className="text-[#401E01]/70 font-medium">
                    {stat.label}
                  </p>
                </Card>
              </motion.div>
